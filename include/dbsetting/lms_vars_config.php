...
$userip = $_SERVER['REMOTE_ADDR']; // server = $_SERVER['REMOTE_ADDR'], local = 103.4.94.182
...
// reCAPTCHA
define('CAPTCHA_SITE_KEY'   , '6LdT0morAAAAAHAiad0js_ZY9iXkfYRuc-vP4k8P');
define('CAPTCHA_SECRET_KEY' , '6LdT0morAAAAAN3N7-h2KB61KTKiPn-PifEIhzgi');
