    ...
    <div class="feature-instructors">
      <div class="section-header aos" data-aos="fade-up">
        <div class="section-sub-head feature-head text-center">
          ...
          <div class="section-text aos" data-aos="fade-up">
            <p class="mb-0">Featured instructors are accomplished professionals or experts highlighted in educational programs for their expertise and contributions to the field.</p>
          </div>
        </div>
      </div>
