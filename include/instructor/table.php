...
$condition = array ( 
                       'select'       =>  "e.emply_id, e.emply_photo, e.emply_name, d.designation_name, e.emply_gender, e.emply_href"
    ...
    <div class="col-lg-3 col-md-6 d-flex">
      <div class="instructor-box flex-fill">
        <div class="instructor-img justify-content-center">
          <a href="'.SITE_URL.'instructors/'.$instructors['emply_href'].'">
            <img class="img-fluid" alt src="'.$photo.'" />
          </a>
        </div>
        <div class="instructor-content">
          <h5><a href="'.SITE_URL.'instructors/'.$instructors['emply_href'].'">'.$instructors['emply_name'].'</a></h5>
