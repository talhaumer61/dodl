...
echo '
                ...
                <div class="col-md-6 login-wrap-bg">
                    <div class="login-wrapper">
                        <div class="loginbox">
                            ...
                            <form method="POST" name="signup" autocomplete="off" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col">                                    
                                ...
                                <div class="row">
                                    <div class="col">                                    
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="cv_url" id="cv_url" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="form-control-label">Portfolio / CV</label>
                                            <input type="file" name="cv_file" id="cv_file" class="form-control" accept=".jpg, .jpeg, .png, .pdf" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary signup_skill_ambassador" name="signup_skill_ambassador">Send Request</button>
                                </div>
    ...
    <script>
        ...
        $(".FirstOTPSend").hide();
        $(".signup_skill_ambassador").prop("disabled", true);
        $(".OTPInput").hide();
                ...
                $.ajax({
                    ...
                    ,success: function(response) {
                        if (response == "code-matched") {
                            ...
                            $(".FirstOTPSend").hide();
                            $(".OTPInput").hide();
                            $(".signup_skill_ambassador").prop("disabled", false);
