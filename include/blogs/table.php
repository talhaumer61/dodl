        ...
        <div class="blog border">
          ...
          <div class="p-3">
            ...
            <div class="blog-content blog-read">
              ...
              <div class="row gx-2">
                <div class="col">
                  <a href="'.SITE_URL.'blogs/'.$row['blog_href'].'" class="btn btn-enroll w-100">Read More</a>
                </div>
                <div class="col">
                  <a class="btn btn-wish w-100" onclick="show_modal(\''.SITE_URL.'include/modals/share_options/share_options.php?title='.cleanvars($row['blog_name']).'&description='.$share_description.'&image='.cleanvars($blog_photo).'&url='.SITE_URL . 'blogs/' . $row['blog_href'].'\');"><i class="feather-share-2"></i> Share</a>
                </div>
              </div>
            </div>
          </div>
