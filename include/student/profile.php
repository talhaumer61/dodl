...
$condition = array ( 
                        'select' 		=>	'e.emply_id, s.id_intrests, s.std_about, s.std_sociallinks, s.std_address_1, s.std_address_2, s.std_postal_address, a.adm_email, a.adm_phone, o.org_name, o.org_referral_link'
                        ,'join'         =>  'LEFT JOIN '.STUDENTS.' s ON a.adm_id = s.std_loginid AND s.is_deleted = 0 AND s.std_status
                                             ...
                                             LEFT JOIN '.SKILL_AMBASSADOR.' o ON s.id_org = o.org_id AND o.is_deleted = 0 AND o.org_status = 1'
                        ,'where' 		=>	array( 
        ...
        <div class="row">
            <div class="col-md-12 col-12">
                <div class="profile-info-blk">
                    ...
                    <p>Learner</p>';
                    echo $row['org_name'] ? '<p>Reffered By: '.$row['org_referral_link'].'</p>' : '';
                    if($sociallinks):
                        echo '
                ...
                <div class="card review-sec">
                    <div class="card-body">
                        ...
                        foreach ($REVIEWS as $key => $rev) {
                            ...
                            // CHECK FILE EXIST
                            $rev_photo = '';
                            if (!empty($rev['rev_photo'])) {
                                $rev_photo = SITE_URL_PORTAL.'uploads/images/reviews/'.$rev['rev_photo'];
                            }
                            echo'
