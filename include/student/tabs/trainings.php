<?php
$conditions = array ( 
                         'select'        =>	'c.curs_name, c.curs_photo, c.curs_id, c.curs_href, c.curs_rating, ec.id_type, ec.secs_id, ec.id_mas, ec.id_ad_prg
                        ...
                        ,'join'         =>	'INNER JOIN '.COURSES.' c ON c.curs_id = ec.id_curs AND c.curs_status = 1 AND c.is_deleted = 0
                                             ...
                                             LEFT JOIN '.LECTURE_TRACKING.' AS lt ON lt.id_curs = c.curs_id AND lt.id_std = '.cleanvars($_SESSION['userlogininfo']['STDID']).' 
                                             AND lt.is_completed = 2 AND lt.is_deleted = 0 AND lt.id_mas = ec.id_mas AND lt.id_ad_prg = ec.id_ad_prg'
                        ,'where' 		=>	array( 
                                                     'ec.is_deleted'    => '0'
                                                    ,'ec.secs_status'   => '1'
                                                    ,'ec.id_type'       => '4'
