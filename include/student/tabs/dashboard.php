...
// ENROLLMENTS
$conditions = array ( 
                         'select'       =>	'c.curs_name, c.curs_photo, c.curs_id, c.curs_href, mt.mas_name, mt.mas_href, 
                                             mt.mas_photo, p.prg_photo, p.prg_href, ap.program, ec.secs_id, ec.id_type, 
                                             ec.secs_status, ec.id_curs, ec.id_mas, ec.id_ad_prg
                            ...
                            foreach ($ENROLLED_COURSES as $row) {
                                ...
                                if($name != ''){
                                    ...
                                    if($type == '3' || $type == '4'){
                                        ...
                                        $COURSES_LESSONS = $dblms->getRows(COURSES_LESSONS.' cl', $con, $sql);
                                        if($COURSES_LESSONS){
