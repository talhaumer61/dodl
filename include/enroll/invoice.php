...
if(isset($_POST['curs_type_status']) && ($_POST['curs_type_status'] == 5)){
                      ...
                      <tbody>';
                        ...
                        if($WISHLIST){
                          foreach ($WISHLIST as $row) {                            
                            ...
                            $total += ($ADMISSION_OFFERING['id_type']!=3?$admoff_amount:0);

                            if($admoff_amount > 0 && $ADMISSION_OFFERING['id_type']!=3){
                              $priceFound = true;
                            }
                            echo '
                            <tr>
                              ...
                              <td class="text-center">'.$currency_code.' '.($ADMISSION_OFFERING['id_type']!=3?$admoff_amount:0).'</td>
