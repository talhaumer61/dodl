...
if (isset($_POST['enrolled_courses'])) {
    ...
    if($enrolled){
        ...
        if($sqllms){
            ...
            foreach ($enroll_id as $value) {
                $values = array(
                                    ...
                                    ,'id_type'                  => cleanvars($id_type[$i]) // 1=prg, 2=mt, 3=curs, 4=trainging
                                    ,'learn_type'               => cleanvars($lrn_type[$i]) // 1=paid, 2=free, 3=learn free
        ...
        if($learn_type==3){
            sessionMsg("Success", "Successfully Enrolled.", "success");
            header("location: ".SITE_URL."student/dashboard");
