        ...
        <div class="relative z-10">';
            ...
            if ($COURSES_LESSONS['lesson_content'] != 2) {
                ...
                <div class="embed-video">
                    <iframe id="youtube-player" src="https://www.youtube.com/embed/'.$COURSES_LESSONS['lesson_video_code'].'?enablejsapi=1&controls=1&rel=0&showinfo=0&modestbranding=1&color=white&disablekb=1&iv_load_policy=3" frameborder="0" uk-video="automute: true;" allowfullscreen uk-responsive></iframe>';
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="text-center">';
                                ...
                                if (!empty($COURSES_ASSIGNMENTS['fileattach'])) {
                                    echo'<a rel="nofollow" download target="_blank" title="Download Assignment File" href="'.SITE_URL_PORTAL.'uploads/files/assignments/'.$COURSES_ASSIGNMENTS['fileattach'].'" class="btn btn-sm btn-primary text-white me-1"><i class="fa fa-download me-1"></i>Assignment File</a>';
                                }
                                // STUDENT UPLOADED FILE 
                                if (!empty($COURSES_ASSIGNMENTS['student_file'])) {
                                    echo'<a rel="nofollow" download target="_blank" title="Download Submited File" href="'.SITE_URL.'uploads/files/student_assignments/'.$COURSES_ASSIGNMENTS['student_file'].'" class="btn btn-sm btn-dark text-white me-1"><i class="fa fa-download me-1"></i>Your File</a>';
                                    // echo'<span class="btn btn-sm btn-success text-white me-1">Assignment Submited</span>';
                                }else{
                                    include 'assignments/query.php';
